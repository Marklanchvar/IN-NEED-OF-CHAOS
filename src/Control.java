public class Control
{
    ...
    public int pys(final float x, final float opx, final float z, final float opz) {
        return (int)Math.sqrt((x - opx) * (x - opx) + (z - opz) * (z - opz));
    }
}
