...
public class xtGraphics extends Panel implements Runnable
{
            ...
            if (abs > 7 || n2 > 0 || n2 == -2 || this.cntan != 0) {
                ...
                if (n2 <= 0) {
                    if (abs <= 45 && n2 != -2 && this.cntan == 0) {
                        r = (int) ((r * abs + this.m.csky[0] * (45 - abs)) / 45);
                        g = (int) ((g * abs + this.m.csky[1] * (45 - abs)) / 45);
                        b2 = (int) ((b2 * abs + this.m.csky[2] * (45 - abs)) / 45);
                    }
                    if (abs >= 90) {
                ...
                if (n2 <= 0) {
                    if (abs <= 45 && n2 != -2 && this.cntan == 0) {
                        r2 = (int) ((r2 * abs + this.m.csky[0] * (45 - abs)) / 45);
                        g2 = (int) ((g2 * abs + this.m.csky[1] * (45 - abs)) / 45);
                        b3 = (int) ((b3 * abs + this.m.csky[2] * (45 - abs)) / 45);
                    }
                }
                else if (this.flk) {
    ...
    public void scrape(final float scx, final float scy, final float scz) {
        if (this.bfscrape == 0 && Math.sqrt(scx * scx + scy * scy + scz * scz) / 10.0 > 10.0) {
            int n4 = 0;
    ...
    public void gscrape(final float scx, final float scy, final float scz) {
        if ((this.bfsc1 == 0 || this.bfsc2 == 0) && Math.sqrt(scx * scx + scy * scy + scz * scz) / 10.0 > 15.0) {
            if (this.bfsc1 == 0) {
                if (!this.mutes) {
                    this.scrape[2].stop();
                    this.scrape[2].play();
    ...
    public void rot(final int[] array, final int[] array2, final int n, final int n2, final float ana2, final int n4) {
        if (ana2 != 0) {
            for (int i = 0; i < n4; ++i) {
                final int n5 = array[i];
                final int n6 = array2[i];
                array[i] = n + (int)((n5 - n) * this.m.cos(ana2) - (n6 - n2) * this.m.sin(ana2));
                array2[i] = n2 + (int)((n5 - n) * this.m.sin(ana2) + (n6 - n2) * this.m.cos(ana2));
            }
        }
    }
    
    public int xs(final float n, float n2) {
        if (n2 < 50) {
            n2 = 50;
        }
