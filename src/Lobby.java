...
public class Lobby implements Runnable
{
        ...
        while (this.conon == 1) {
            ...
            if ((this.join >= 0 || this.pgames[this.im] != -1) && !this.regnow) {
                ...
                if (n2 != -1) {
                    ...
                    if (this.gclss[n2] > 0 && this.gclss[n2] <= 5 && Math.abs(this.cd.cclass.get(this.pcars[this.im]) - (this.gclss[n2] - 1)) > 1) {
                        b = true;
                        if (this.gcrs[n2] == 1) {
                            if (this.gwarb[n2] == 0) {
                                this.ontyp = 10;
            ...
            if (this.xt.sc[0] >= 16) {
                str = "C" + this.cd.names.get(this.xt.sc[0]) + "";
            }
                ...
                if (svalue.startsWith("C")) {
                    ...
                    if (!this.pcarnames[n6].equals("")) {
                        ...
                        for (int n8 = 16; n8 < 56; ++n8) {
                            if (this.pcarnames[n6].equals(this.cd.names.get(n8))) {
                                n7 = n8;
                                break;
                            }
                        }
                        ...
                        this.pcars[n6] = 0;
                        this.pcarnames[n6] = this.cd.names.get(this.pcars[n6]);
                    }
                }
                else {
                ...
                if (this.xt.gameport != -1) {
                    ...
                    for (int n38 = 0; n38 < this.xt.nplayers; ++n38) {
                        ...
                        if (svalue2.startsWith("C")) {
                            ...
                            if (!substring.equals("")) {
                                int n39 = 0;
                                for (int n40 = 16; n40 < this.cd.names.size(); ++n40) {
                                    if (substring.equals(this.cd.names.get(n40))) {
                                        n39 = n40;
                                        break;
                                    }
                                }
                                while (n39 == 0 && n36 < 100) {
                                    ...
                                    for (int n42 = 16; n42 < this.cd.names.size(); ++n42) {
                                        if (substring.equals(this.cd.names.get(n42))) {
                                            n39 = n42;
                                        }
                                    }
                                    ++n36;
                        ...
                        if (svalue3.startsWith("C")) {
                            ...
                            if (!substring2.equals("")) {
                                ...
                                for (int n62 = 16; n62 < 56; ++n62) {
                                    if (substring2.equals(this.cd.names.get(n62))) {
                                        n61 = n62;
                                        break;
                                    }
                                }
                                while (n61 == 0 && n57 < 100) {
                                    ...
                                    for (int n64 = 16; n64 < 56; ++n64) {
                                        if (substring2.equals(this.cd.names.get(n64))) {
                                            n61 = n64;
                                        }
                                    }
                                    ++n57;
    ...
    public void lobby(int n, int n2, boolean b, final int n3, final CheckPoints checkPoints, final Control control, final ArrayList<ContO> array) {
        this.pre1 = false;
        this.pre2 = false;
        int n4 = 0;
        Label_49761: {
                ...
                if (this.ontyp == 76) {
                    ...
                    if (this.ontyp <= -2) {
                        if (Math.abs(this.ontyp + 2) != 13) {
                            s = "" + this.cd.names.get(Math.abs(this.ontyp + 2)) + " Game";
                        }
                        else {
                            s = " " + this.cd.names.get(Math.abs(this.ontyp + 2)) + "  Game";
                        }
                    ...
                    if (this.ontyp <= -2) {
                        if (Math.abs(this.ontyp + 2) != 13) {
                            str = "" + this.cd.names.get(Math.abs(this.ontyp + 2)) + "";
                        }
                        else {
                            str = " " + this.cd.names.get(Math.abs(this.ontyp + 2)) + " ";
                        }
                                    ...
                                    if (this.conon != 1) {
                                        ...
                                        if (this.wait[n24] > 0) {
                                            if (this.gwarb[n24] != 0) {
                                                ...
                                                String s5 = null;
                                                if (this.gclss[n24] <= -2) {
                                                    s5 = "" + this.cd.names.get(Math.abs(this.gclss[n24] + 2)) + "";
                                                }
                                                else {
                                                    if (this.gcrs[n24] == 1) {
                                                        s4 = "Custom Cars";
                                            ...
                                            Label_30695: {
                                                if (this.wait[n24] == -1) {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        boolean b10;
                                                        boolean b11;
                                                        Label_30159_Outer:Label_30453_Outer:
                                    ...
                                    for (int n40 = 0; n40 < this.npo; ++n40) {
                                        if (this.pgames[n40] == this.ongame) {
                                            ...
                                            if (this.pcars[n40] == -1) {
                                                ...
                                                for (int n42 = 0; n42 < array.get(this.pcars[n40]).npl; ++n42) {
                                                    array.get(this.pcars[n40]).p.get(n42).flx = 0;
                                                    if (array.get(this.pcars[n40]).p.get(n42).colnum == 1) {
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[0] = this.pcols[n40][0];
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[1] = this.pcols[n40][1];
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[2] = 1.0f - this.pcols[n40][2];
                                                    }
                                                    if (array.get(this.pcars[n40]).p.get(n42).colnum == 2) {
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[0] = this.pcols[n40][3];
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[1] = this.pcols[n40][4];
                                                        array.get(this.pcars[n40]).p.get(n42).hsb[2] = 1.0f - this.pcols[n40][5];
                                                    }
                                                }
                                                if (this.cac[n39] != this.pcars[n40]) {
                                                    float n44;
                                                    float n43 = n44 = array.get(this.pcars[n40]).p.get(0).oy[0];
                                                    float n46;
                                                    float n45 = n46 = array.get(this.pcars[n40]).p.get(0).oz[0];
                                                    for (int n47 = 0; n47 < array.get(this.pcars[n40]).npl; ++n47) {
                                                        for (int n48 = 0; n48 < array.get(this.pcars[n40]).p.get(n47).n; ++n48) {
                                                            if (array.get(this.pcars[n40]).p.get(n47).oy[n48] < n43) {
                                                                n43 = array.get(this.pcars[n40]).p.get(n47).oy[n48];
                                                            }
                                                            if (array.get(this.pcars[n40]).p.get(n47).oy[n48] > n44) {
                                                                n44 = array.get(this.pcars[n40]).p.get(n47).oy[n48];
                                                            }
                                                            if (array.get(this.pcars[n40]).p.get(n47).oz[n48] < n45) {
                                                                n45 = array.get(this.pcars[n40]).p.get(n47).oz[n48];
                                                            }
                                                            if (array.get(this.pcars[n40]).p.get(n47).oz[n48] > n46) {
                                                                n46 = array.get(this.pcars[n40]).p.get(n47).oz[n48];
                                                            }
                                                        }
                                                    }
                                                    this.cax[n39] = (int) ((n44 + n43) / 2);
                                                    this.cay[n39] = (int) ((n46 + n45) / 2);
                                                    ...
                                                    if (n < 402) {
                                                        if (n2 > 57 + n39 * 42) {
                                                            if (n2 < 91 + n39 * 42) {
                                                                n4 = 12;
                                                                dispcar = n40;
                                                                for (int n49 = 0; n49 < array.get(this.pcars[n40]).npl; ++n49) {
                                                                    array.get(this.pcars[n40]).p.get(n49).flx = 77;
                                                                }
                                                            }
                                                        }
                                                    }
                                                }
                                                array.get(this.pcars[n40]).y = 2500 - n39 * 80;
                                                array.get(this.pcars[n40]).z = 150 + 250 * n39 - this.cay[n39];
                                                array.get(this.pcars[n40]).x = -145 - this.cax[n39];
                                                array.get(this.pcars[n40]).pitch = 0;
                                                array.get(this.pcars[n40]).yaw = -90;
                                                array.get(this.pcars[n40]).roll = this.pend - n39 * 5;
                                                array.get(this.pcars[n40]).d(this.rd);
                                            }
                                            ++n39;
                                        }
                                    }
                                                ...
                                                if (this.dispcar != dispcar) {
                                                    if (dispcar != -1) {
                                                        if (this.cd.action != 6) {
                                                            ...
                                                            this.dispco = null;
                                                            System.gc();
                                                            this.dispco = new ContO(array.get(this.forcar), 0, 0, 0, 0);
                                                            break Label_33369;
                                                        }
                                                    }
                                                }
                                        ...
                                        if (this.conon == 1) {
                                            ...
                                            if (this.pcars[this.dispcar] == this.forcar) {
                                                if (this.forcar != -1) {
                                                    ...
                                                    this.rd.setFont(new Font("Arial", 1, 13));
                                                    this.ftm = this.rd.getFontMetrics();
                                                    this.rd.drawString(this.cd.names.get(this.forcar), 561 - this.ftm.stringWidth(this.cd.names.get(this.forcar)) / 2, 117);
                                                    for (int n55 = 0; n55 < this.dispco.npl; ++n55) {
                                                        if (array.get(this.forcar).p.get(n55).colnum == 1) {
                                                            this.dispco.p.get(n55).hsb[0] = this.pcols[this.dispcar][0];
                                                            this.dispco.p.get(n55).hsb[1] = this.pcols[this.dispcar][1];
                                                            this.dispco.p.get(n55).hsb[2] = 1.0f - this.pcols[this.dispcar][2];
                                                        }
                                                        if (array.get(this.forcar).p.get(n55).colnum == 2) {
                                                            this.dispco.p.get(n55).hsb[0] = this.pcols[this.dispcar][3];
                                                            this.dispco.p.get(n55).hsb[1] = this.pcols[this.dispcar][4];
                                                    ...
                                                    this.rd.setColor(this.color2k(255, 255, 255));
                                                    float n58 = (this.cd.swits.get(this.forcar)[2] - 220) / 90.0f;
                                                    if (n58 < 0.2) {
                                                        n58 = 0.2f;
                                                    }
                                                    this.rd.fillRect((int)(97.0f + 156.0f * n58) + n56, 312 + n57, (int)(156.0f * (1.0f - n58) + 1.0f), 7);
                                                    float n59 = this.cd.acelf.get(this.forcar)[1] * this.cd.acelf.get(this.forcar)[0] * this.cd.acelf.get(this.forcar)[2] * this.cd.grip.get(this.forcar) / 7700.0f;
                                                    if (n59 > 1.0f) {
                                                        n59 = 1.0f;
                                                    }
                                                    ...
                                                    this.rd.setColor(this.color2k(255, 255, 255));
                                                    float n62 = (this.cd.airc.get(this.forcar) * this.cd.airs.get(this.forcar) * this.cd.bounce.get(this.forcar) + 28.0f) / 139.0f;
                                                    if (n62 > 1.0f) {
                                                        n62 = 1.0f;
                                                    }
                                                    this.rd.fillRect((int)(471.0f + 156.0f * n62) + n60, 312 + n61, (int)(156.0f * (1.0f - n62) + 1.0f), 7);
                                                    float n63 = (this.cd.moment.get(this.forcar) + 0.5f) / 2.6f;
                                                    if (n63 > 1.0f) {
                                                        n63 = 1.0f;
                                                    }
                                                    this.rd.fillRect((int)(471.0f + 156.0f * n63) + n60, 327 + n61, (int)(156.0f * (1.0f - n63) + 1.0f), 7);
                                                    final float n64 = this.cd.outdam.get(this.forcar);
                                                    ...
                                                    Label_47291: {
                                                        if (this.forcar >= 16) {
                                                            this.rd.setFont(new Font("Arial", 1, 12));
                                                            this.ftm = this.rd.getFontMetrics();
                                                            if (this.cd.createdby.get(this.forcar - 16).equals(this.xt.nickname)) {
                                                                this.rd.drawString("Created by You", 561 - this.ftm.stringWidth("Created by You") / 2, 347);
                                                            }
                                                            else {
                                                                this.rd.drawString("Created by :  " + this.cd.createdby.get(this.forcar - 16) + "", 561 - this.ftm.stringWidth("Created by :  " + this.cd.createdby.get(this.forcar - 16) + "") / 2, 347);
                                                                final int stringWidth = this.ftm.stringWidth(this.cd.createdby.get(this.forcar - 16));
                                                                final int n65 = 561 - this.ftm.stringWidth("Created by :  " + this.cd.createdby.get(this.forcar - 16) + "") / 2 + this.ftm.stringWidth("Created by :  " + this.cd.createdby.get(this.forcar - 16) + "") - stringWidth;
                                                                ...
                                                                if (n > n65 - 2) {
                                                                    if (n < n65 + stringWidth) {
                                                                        if (n2 > 334) {
                                                                            if (n2 < 351) {
                                                                                if (b) {
                                                                                    if (!this.gb.proname.equals(this.cd.createdby.get(this.forcar - 16))) {
                                                                                        this.gb.proname = this.cd.createdby.get(this.forcar - 16);
                                                                                        this.gb.loadedp = false;
                                                                                    }
                                                                                    this.gb.tab = 1;
                                                                                    this.gb.open = 2;
                                                            ...
                                                            this.rd.setColor(new Color(128, 73, 0));
                                                            String s7 = "";
                                                            if (this.cd.cclass.get(this.forcar) == 0) {
                                                                s7 = "Class C ,  ";
                                                            }
                                                            if (this.cd.cclass.get(this.forcar) == 1) {
                                                                s7 = "Class B & C ,  ";
                                                            }
                                                            if (this.cd.cclass.get(this.forcar) == 2) {
                                                                s7 = "Class B ,  ";
                                                            }
                                                            if (this.cd.cclass.get(this.forcar) == 3) {
                                                                s7 = "Class A & B ,  ";
                                                            }
                                                            if (this.cd.cclass.get(this.forcar) == 4) {
                                                                s7 = "Class A ,  ";
                                                            }
                                                            if (this.cd.publish.get(this.forcar - 16) == 0) {
                                                                s7 += "Private Car";
                                                            }
                                                            if (this.cd.publish.get(this.forcar - 16) == 1) {
                                                                s7 += "Public Car";
                                                                this.rd.setColor(new Color(0, 64, 128));
                                                            }
                                                            if (this.cd.publish.get(this.forcar - 16) == 2) {
                                                                s7 += "Super Public Car";
                                                                this.rd.setColor(new Color(0, 64, 128));
                                                            }
                                                            ...
                                                            if (this.cd.action == 7) {
                                                                this.rd.drawString("" + this.cd.names.get(this.cd.ac) + " has been added to your cars!", 561 - this.ftm.stringWidth("" + this.cd.names.get(this.cd.ac) + " has been added to your cars!") / 2, 395);
                                                            }
                                                            if (this.cd.action == -7) {
                                ...
                                if (this.chalngd == -4) {
                                    ...
                                    if (this.xt.sc[0] >= 16) {
                                        ...
                                        if (!this.gs.mycar.isShowing()) {
                                            this.gs.mycar.show();
                                            this.gs.mycar.setLabel("" + this.cd.names.get(this.xt.sc[0]) + " Game!");
                                            if (this.gclass > -2) {
                                                this.gs.mycar.setState(false);
                                            }
                                            else {
